 ...
 * @param options.falseOnSubmit - If true, isDirty will equal false after successful form submission to permit redirection
 *
...
export function useIsDirty<T extends FieldValues>(form: UseFormReturn<T>, { falseOnSubmit = false } = {}) {
  ...
  return useMemo(() => {
    ...
    if (falseOnSubmit && form.formState.isSubmitSuccessful) return false;
